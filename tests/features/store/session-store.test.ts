...
import {
  ...
  loadSession,
  updateSession,
} from "../../../src/features/store/session-store.ts";
...
describe("session store", () => {
  ...
  it("appends transcript and action events as JSONL and exports copyable formats", async () => {
    ...
    await appendSessionEvent("session-2", {
      id: "event-1",
      type: "message",
      role: "user",
    ...
    expect(exported.transcript).toContain("[2026-04-28T10:02:00.000Z] action grep completed: found 2 matches");
